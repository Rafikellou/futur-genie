...
export function TeacherSignup({ token, onBack }: TeacherSignupProps) {
      ...
      <div className="w-full max-w-md">
        <div className="card-dark p-8 rounded-xl">
          ...
          <div className="text-center mb-8">
            ...
            <h1 className="text-3xl font-bold text-white mb-2">Inscription Enseignant</h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button 
              type="submit" 
              disabled={loading}
              className="w-full py-3 px-4 btn-gradient gradient-accent text-white rounded-lg font-medium transition-all duration-200 hover-lift disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
            >
